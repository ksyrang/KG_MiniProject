...
public class DeleteDTO {
		...
		public DeleteDTO(DeleteDTO deleteDTO) {
			MEM_Code = deleteDTO.getMEM_Code();
			MEM_ID = deleteDTO.getMEM_ID();
			MEM_PW = deleteDTO.getMEM_PW();
			MEM_Name = deleteDTO.getMEM_Name();
			MEM_Gender = deleteDTO.getMEM_Gender();
			MEM_Birth = deleteDTO.getMEM_Birth();
			MEM_Mobile = deleteDTO.getMEM_Mobile();
			MEM_Addr = deleteDTO.getMEM_Addr();
			PRMSCHE_Code = deleteDTO.getPRMSCHE_Code();
			MEMSHIPSCHE_Code = deleteDTO.getMEMSHIPSCHE_Code();
			MEM_Approve = deleteDTO.getMEM_Approve();
		}
		
		public DeleteDTO(String mEM_Code, String mEM_ID, String mEM_PW, String mEM_Name, String mEM_Gender, int mEM_Birth,
