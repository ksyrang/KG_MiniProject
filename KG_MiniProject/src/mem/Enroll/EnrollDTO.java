...
public class EnrollDTO {
	...
	public EnrollDTO(EnrollDTO enrollDTO) {
		MEM_Code = enrollDTO.getMEM_Code();
		MEM_ID = enrollDTO.getMEM_ID();
		MEM_PW = enrollDTO.getMEM_PW();
		MEM_Name = enrollDTO.getMEM_Name();
		MEM_Gender = enrollDTO.getMEM_Gender();
		MEM_Birth = enrollDTO.getMEM_Birth();
		MEM_Mobile = enrollDTO.getMEM_Mobile();
		MEM_Addr = enrollDTO.getMEM_Addr();
		PRMSCHE_Code = enrollDTO.getPRMSCHE_Code();
		MEMSHIPSCHE_Code = enrollDTO.getMEMSHIPSCHE_Code();
		MEM_Approve = enrollDTO.getMEM_Approve();
	}
	
	public EnrollDTO(String mEM_Code, String mEM_ID, String mEM_PW, String mEM_Name, String mEM_Gender, int mEM_Birth,
